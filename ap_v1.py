...
JP_SECTORS = ["水産・農林業", "鉱業", "建設業", "食料品", "繊維製品", "パルプ・紙", "化学", "医薬品", "石油・石炭製品", "ゴム製品", "ガラス・土石製品", "鉄鋼", "非鉄金属", "金属製品", "機械", "電気機器", "輸送用機器", "精密機器", "その他製品", "電気・ガス業", "陸運業", "海運業", "空運業", "倉庫・運輸関連業", "情報・通信業", "卸売業", "小売業", "銀行業", "証券、商品先物取引業", "保険業", "その他金融業", "不動産業", "サービス業"]
US_SECTORS = ["テクノロジー", "金融", "ヘルスケア", "一般消費財", "生活必需品", "エネルギー", "公益事業", "不動産", "素材", "資本財", "通信サービス"]
SENSITIVITY_MAP = {
    "ディフェンシブ": ["水産・農林業","食料品","医薬品","電気・ガス業","陸運業","情報・通信業","小売業","サービス業"],
    "景気敏感": ["鉱業","建設業","化学","石油・石炭製品","ゴム製品","ガラス・土石製品","鉄鋼","非鉄金属","金属製品","機械","電気機器","輸送用機器","精密機器","その他製品","海運業","空運業","倉庫・運輸関連業","卸売業","銀行業","証券、商品先物取引業","保険業","その他金融業","不動産業","パルプ・紙","繊維製品"],
    "中立/現金": ["現金"]
}
